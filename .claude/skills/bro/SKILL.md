...
## Plain pass on a deliverable

When the user aims /bro at a draft, file, or pasted text (email, forum post, page copy, doc): rewrite that text itself, not an explanation of it, under the `writing` skill's rules at their plainest, with short sentences and one idea each, in the user's own voice. Deliver the rewritten text; do not ask first.
